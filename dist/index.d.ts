...
export type { LinkRuntimeOptions, NavigationGuard, NavigationGuardContext, NavigationOptions, RoutePrefetchRule, RuntimePrefetchOptions } from "./runtime/link-runtime.js";
...
export type { AdaptivePrefetchOptions, PrefetchAsset, PrefetchAssetInput, PrefetchDiagnostics, PrefetchDiagnosticReason, PrefetchFetcher, PrefetchSchedulerOptions, PrefetchTaskOptions, SpeculationRulesOptions } from "./prefetch/scheduler.js";
...
export type { OfflineNavigationManagerOptions, OfflineQueueAddedDetail, OfflineSyncedDetail, OfflineSyncingDetail, QueuedNavigation } from "./offline/offline-navigation.js";
